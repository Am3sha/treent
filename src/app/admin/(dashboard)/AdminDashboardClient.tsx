  ...
  return (
    <ThemeProvider defaultTheme="light" enableSystem={false}>
      ...
      <div className="flex h-screen">
        ...
        <aside
          className={cn(
            "fixed inset-y-0 left-0 z-50 w-64 transform border-r border-border/60 bg-[#FAFBFA] transition-transform transition-all duration-300 md:static md:translate-x-0",
